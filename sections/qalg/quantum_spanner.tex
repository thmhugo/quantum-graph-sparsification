...
In \autoref{alg:quantum_spt}, %the routine $\textsc{MINFIND}(f,g,d)$ will be called with $d = |P_L|$ and
...
Taking into account \Autoref{thm:comp-spt}, one can conclude on the overall time complexity of \autoref{alg:quantum-spanner}.
